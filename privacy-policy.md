...
To provide Stella, we share limited data with the following service providers:
...
We protect your data using access controls that ensure you can only read and write your own records, encryption in transit, and server-side handling of all API credentials. No system is perfectly secure, but we take reasonable measures appropriate to the sensitivity of the data.

If a personal data breach occurs, we will notify affected users and the Data Protection Board as required.
...
**Grievance Officer:** Sameer Mohammad
